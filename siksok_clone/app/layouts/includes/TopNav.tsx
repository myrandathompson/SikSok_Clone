...
export default function TopNav() {
    ...
    return (
        ...
        <div id="TopNav" className="fixed bg-white z-30 flex items-left w-full border-b h-[60px]">
            <div className={`flex items-center justify-between gap-6 w-full px-4 mx-auto ${pathname === '/' ? 'max-w-[1150px]' : ''}`}>
                    ...
                    <input
                        ...
                        <div className="absolute bg-white max-w-[910px] h-auto w-full z-20 left-0 top-12 border p-1">
                            <div className="p-1">
                                <Link
                                    href={`/profile/1`}
                                    className="flex items-center justify-between w-full cursor-pointer hover:bg-[#60e4f8] p-1 px-2 hover:text-white">

                                        <div className="flex items-center">
                                            <img className="rounded-md" width="40" src="https://placehold.com/40" />
                                            <div className="truncate ml-2">Myranda</div>
                                        </div>
                                    </Link>
                            </div>
                        </div>
                ...
                <div className='flex items-center gap-3'>
                    ...
                    <AiOutlinePlus color="#94e0ef" size="22" />
                ...
                <div className="flex items-center">
                    <button
                    className="flex items-center bg-[#2cc9f0] text-white border rounded-md px-3 py-[6px]"
                    >
                        <span className="whitespace-nowrap mx-4 font-medium text-[15px]">Log in</span>
                    </button>
                    <BsThreeDotsVertical color="#27eee8" size="25" />
                    </div>
                    ) : (
                    <div className="flex items-center">
